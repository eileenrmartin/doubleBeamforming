...
locationsA = calcDistFromAvg(filenamesA,'data/coordinatesA'+str(nSensors)+'.txt') # no. of sensors in A x 2 
locationsB = calcDistFromAvg(filenamesB,'data/coordinatesB'+str(nSensors)+'.txt') # no. of sensors in B x 2
